...
%%%% Modificado por Álvaro Millán ---- adaptado a Intel Edison %%%%

%% Create an Arduino object with the necessary add-ons.
a = arduino('COM4', 'Uno', 'Libraries', {'JRodrigoTech/HCSR04', 'Servo'});
% b= edison('COM9', 'Uno', 'Libraries' edison({JRodrigoTech/HCSR04',
% 'Servo'});
...
sensor = addon(a, 'JRodrigoTech/HCSR04', 'D12', 'D13'); %%cambiar a por b 
servo_motor = servo(a, 'D3'); %%no utilizaremos el motor 

%% Rotate the servo motor from 0 to 180 degrees.
%%No necesitamos rotación
